...
export function MobileSidebarToggle({ session }: MobileSidebarToggleProps) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 rounded-4xl bg-card border p-2 md:hidden shadow-md"
