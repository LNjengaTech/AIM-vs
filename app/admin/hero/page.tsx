...
import { Loader2, Save, Eye, Image as ImageIcon, Sparkles, SwitchCamera } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
               <div className="space-y-2">
                  ...
                  />
                  <p className="text-[10px] text-muted-foreground">Tip: Leaving this empty will use the accent color gradient</p>
               </div>
